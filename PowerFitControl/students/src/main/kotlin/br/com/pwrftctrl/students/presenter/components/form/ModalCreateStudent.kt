...
@Composable
fun ModalCreateStudent(onDismissRequest: () -> Unit) {
        ...
        BaseModal(onDismissRequest = onDismissRequest) {
                ProgressIndicatorSide(
                        ...
                        LazyColumn(
                                ...
                                when (formName) {
                                        formStudentData.toString() ->
                                                FieldsStudentData(formStudentData)
                                        formStudentAddress.toString() ->
                                                FieldsStudentAddress(formStudentAddress)
                                        formStudentRegistrationData.toString() ->
                                                FieldsStudentRegistrationData(
                                                        formStudentRegistrationData
                                                )
                                }
                        }
                }
